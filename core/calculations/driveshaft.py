...
from core.functions.angle_between_vectors import vectorsAngle
...
def run_driveshaft():
    ...
    for i in range(0, S.sample_points * 2 + 1):
        ...
        travel.F.T_case_U_joint_angle_rad[i] = vectorsAngle(
            solver.F.T_case_vector[x],
            solver.F.T_case_vector[y],
            solver.F.T_case_vector[z],
            solver.driveshaft_delta[x],
            solver.driveshaft_delta[y],
            solver.driveshaft_delta[z]
        )

        travel.F.pinion_U_joint_angle_rad[i] = vectorsAngle(
            solver.pinion_vector[x],
            solver.pinion_vector[y],
            solver.pinion_vector[z],
            solver.driveshaft_delta[x],
            solver.driveshaft_delta[y],
            solver.driveshaft_delta[z]
        )
        ...
        travel.R.T_case_U_joint_angle_rad[i] = vectorsAngle(
            solver.R.T_case_vector[x],
            solver.R.T_case_vector[y],
            solver.R.T_case_vector[z],
            solver.driveshaft_delta[x],
            solver.driveshaft_delta[y],
            solver.driveshaft_delta[z]
        )

        travel.R.pinion_U_joint_angle_rad[i] = vectorsAngle(
            solver.pinion_vector[x],
            solver.pinion_vector[y],
            solver.pinion_vector[z],
            solver.driveshaft_delta[x],
