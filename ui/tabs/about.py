...
7.alpha.2 2025.02.14
Revision by Treefrog
    Fixed shock travel data type issue with loading suspension.
    Fixed issue with loading suspension on some about
    and shock pages.
    Remembered to update tool name unlike 7.alpha.1.
7.alpha.3 2025.02.16
Revision by Treefrog
    Fixed issue dispalying rear pinion angle
    Changed to math for u-joint angle to unit vector based
7.alpha.4 2026.06.11
Revision by Treefrog
    Fixed issue with add material having swapped values
    Fixed mistake in anti calculations regarding handling of
    of the opposite end's unspruing mass
    Made the tab refresh when loading a suspension from a file
                                    """,
            )
