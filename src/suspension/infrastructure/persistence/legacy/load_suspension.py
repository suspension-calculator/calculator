...
def load_susp():
    ...
    from suspension.core.services.calculations import run_driveshaft
    from suspension.core.services.calculations import run_shocks
    from suspension.core.services.calculations.vehicle_pitch import run_vehicle_pitch
    ...
    S.file_mame = filedialog.askopenfilename(
        initialdir=Path.cwd(),
        title="Open File",
