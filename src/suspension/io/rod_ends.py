...
def load_rod_ends():
    ...
    with open('Lists/rod ends.txt', mode='r') as csv_file:
        ...
        for row in csv_reader:
            ...
            constant.rod_ends.hole_diameter.append(row[csv_reader.fieldnames[3]].replace(" ", ""))
            constant.rod_ends.shank_diameter.append(float(row[csv_reader.fieldnames[4]]))
            constant.rod_ends.thread.append(row[csv_reader.fieldnames[5]].replace(" ", ""))