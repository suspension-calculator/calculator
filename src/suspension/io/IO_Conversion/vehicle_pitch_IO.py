# VariablesIO/IO_Conversion/vehicle_pitch_IO.py

def input_processing_vehicle_pitch():
    from VariableIO.initialize_IO import inputs
    from VariableIO.variables import constant,S
...
def output_processing_vehicle_pitch():
    ...
    outputs.Pitch.User_Input.Body_Roll_Axis = degrees(atan(constant.pitch.body_roll_slope_dpd[temp]))
    ...
    outputs.Pitch.User_Input.F.Roll_Slope = degrees(atan(constant.pitch.F.roll_slope_dpd[temp]))
    ...
    outputs.Pitch.User_Input.R.Roll_Slope = degrees(atan(constant.pitch.R.roll_slope_dpd[temp]))
    
    temp = 1 # full front
    outputs.Pitch.Full_Front.Angle = constant.pitch.angle[temp]*1
    outputs.Pitch.Full_Front.Body_Roll_Axis = degrees(atan(constant.pitch.body_roll_slope_dpd[temp]))
    ...
    outputs.Pitch.Full_Front.F.Roll_Slope = degrees(atan(constant.pitch.F.roll_slope_dpd[temp]))
    ...
    outputs.Pitch.Full_Front.R.Roll_Slope = degrees(atan(constant.pitch.R.roll_slope_dpd[temp]))

    temp = 2 # half front
    outputs.Pitch.Half_Front.Angle = constant.pitch.angle[temp]*1
    outputs.Pitch.Half_Front.Body_Roll_Axis = degrees(atan(constant.pitch.body_roll_slope_dpd[temp]))
    ...
    outputs.Pitch.Half_Front.F.Roll_Slope = degrees(atan(constant.pitch.F.roll_slope_dpd[temp]))
    ...
    outputs.Pitch.Half_Front.R.Roll_Slope = degrees(atan(constant.pitch.R.roll_slope_dpd[temp]))

    temp = 3 # half rear
    outputs.Pitch.Half_Rear.Angle = constant.pitch.angle[temp]*1
    outputs.Pitch.Half_Rear.Body_Roll_Axis = degrees(atan(constant.pitch.body_roll_slope_dpd[temp]))
    ...
    outputs.Pitch.Half_Rear.F.Roll_Slope = degrees(atan(constant.pitch.F.roll_slope_dpd[temp]))
    ...
    outputs.Pitch.Half_Rear.R.Roll_Slope = degrees(atan(constant.pitch.R.roll_slope_dpd[temp]))

    temp = 4 # full rear
    outputs.Pitch.Full_Rear.Angle = constant.pitch.angle[temp]*1
    outputs.Pitch.Full_Rear.Body_Roll_Axis = degrees(atan(constant.pitch.body_roll_slope_dpd[temp]))
    ...
    outputs.Pitch.Full_Rear.F.Roll_Slope = degrees(atan(constant.pitch.F.roll_slope_dpd[temp]))
    ...
    outputs.Pitch.Full_Rear.R.Roll_Slope = degrees(atan(constant.pitch.R.roll_slope_dpd[temp]))

    temp = 5 # full up
    outputs.Pitch.Full_Up.Angle = constant.pitch.angle[temp]*1
    outputs.Pitch.Full_Up.Body_Roll_Axis = degrees(atan(constant.pitch.body_roll_slope_dpd[temp]))
    ...
    outputs.Pitch.Full_Up.F.Roll_Slope = degrees(atan(constant.pitch.F.roll_slope_dpd[temp]))
    ...
    outputs.Pitch.Full_Up.R.Roll_Slope = degrees(atan(constant.pitch.R.roll_slope_dpd[temp]))

    temp = 6 # full down
    outputs.Pitch.Full_Down.Angle = constant.pitch.angle[temp]*1
    outputs.Pitch.Full_Down.Body_Roll_Axis = degrees(atan(constant.pitch.body_roll_slope_dpd[temp]))
    ...
    outputs.Pitch.Full_Down.F.Roll_Slope = degrees(atan(constant.pitch.F.roll_slope_dpd[temp]))
    ...
    outputs.Pitch.Full_Down.R.Roll_Slope = degrees(atan(constant.pitch.R.roll_slope_dpd[temp]))
    ...
    # if metric convert all outputs to metric
        ...
        outputs.Pitch.User_Input.Sprung_Mass_CG = in2mm(constant.pitch.sprung_mass_CG[temp])

        outputs.Pitch.User_Input.F.Roll_Center = in2mm(constant.pitch.F.roll_center[temp])
        ...
        outputs.Pitch.User_Input.R.Roll_Center = in2mm(constant.pitch.R.roll_center[temp])
        ...
        outputs.Pitch.Full_Front.Sprung_Mass_CG = in2mm(constant.pitch.sprung_mass_CG[temp])

        outputs.Pitch.Full_Front.F.Roll_Center = in2mm(constant.pitch.F.roll_center[temp])
        ...
        outputs.Pitch.Full_Front.R.Roll_Center = in2mm(constant.pitch.R.roll_center[temp])
        ...
        outputs.Pitch.Half_Front.Sprung_Mass_CG = in2mm(constant.pitch.sprung_mass_CG[temp])

        outputs.Pitch.Half_Front.F.Roll_Center = in2mm(constant.pitch.F.roll_center[temp])
        ...
        outputs.Pitch.Half_Front.R.Roll_Center = in2mm(constant.pitch.R.roll_center[temp])
        ...
        outputs.Pitch.Half_Rear.Sprung_Mass_CG = in2mm(constant.pitch.sprung_mass_CG[temp])

        outputs.Pitch.Half_Rear.F.Roll_Center = in2mm(constant.pitch.F.roll_center[temp])
        ...
        outputs.Pitch.Half_Rear.R.Roll_Center = in2mm(constant.pitch.R.roll_center[temp])
        ...
        outputs.Pitch.Full_Rear.Sprung_Mass_CG = in2mm(constant.pitch.sprung_mass_CG[temp])

        outputs.Pitch.Full_Rear.F.Roll_Center = in2mm(constant.pitch.F.roll_center[temp])
        ...
        outputs.Pitch.Full_Rear.R.Roll_Center = in2mm(constant.pitch.R.roll_center[temp])
        ...
        outputs.Pitch.Full_Up.Sprung_Mass_CG = in2mm(constant.pitch.sprung_mass_CG[temp])
        ...
        outputs.Pitch.Full_Down.Sprung_Mass_CG = in2mm(constant.pitch.sprung_mass_CG[temp])

        outputs.Pitch.Full_Down.F.Roll_Center = in2mm(constant.pitch.F.roll_center[temp])
        ...
        outputs.Pitch.Full_Down.R.Roll_Center = in2mm(constant.pitch.R.roll_center[temp])
        ...
        outputs.Pitch.User_Input.Sprung_Mass_CG = constant.pitch.sprung_mass_CG[temp]*1
        ...
        outputs.Pitch.Full_Front.Sprung_Mass_CG = constant.pitch.sprung_mass_CG[temp]*1
        ...
        outputs.Pitch.Half_Front.Sprung_Mass_CG = constant.pitch.sprung_mass_CG[temp]*1
