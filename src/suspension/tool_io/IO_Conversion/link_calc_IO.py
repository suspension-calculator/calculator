...
# IO Imports
from tool_io.initialize_IO import inputs, outputs
from tool_io.variables import constant, travel, S, x
...
def input_processing_link_calc():
    ...
    if S.units == "metric":
        ...
        if constant.F.panhard:
            constant.F.PA = mm2in(inputs.F.PA)
        if constant.F.panhard:
            constant.F.PF = mm2in(inputs.F.PF)
        ...
        if constant.R.panhard:
            constant.R.PA = mm2in(inputs.R.PA)
        if constant.R.panhard:
            constant.R.PR = mm2in(inputs.R.PF)
        ...
        if constant.F.panhard:
            constant.F.PA = inputs.F.PA * 1
        if constant.F.panhard:
            constant.F.PF = inputs.F.PF * 1
        ...
        if constant.R.panhard:
            constant.R.PA = inputs.R.PA * 1
        if constant.R.panhard:
            constant.R.PF = inputs.R.PF * 1
...
def output_processing_link_calc():
    ...
    outputs.F.UF_side_view_angle_range = [
        degrees(constant.F.UF_side_view_angle_range[0]),
        degrees(constant.F.UF_side_view_angle_range[1]),
    ]
    outputs.F.UA_side_view_angle_range = [
        degrees(constant.F.UA_side_view_angle_range[0]),
        degrees(constant.F.UA_side_view_angle_range[1]),
    ]
    outputs.F.L_top_view_angle = degrees(constant.F.L_top_view_angle)
    outputs.F.LF_side_view_angle_range = [
        degrees(constant.F.LF_side_view_angle_range[0]),
        degrees(constant.F.LF_side_view_angle_range[1]),
    ]
    outputs.F.LA_side_view_angle_range = [
        degrees(constant.F.LA_side_view_angle_range[0]),
        degrees(constant.F.LA_side_view_angle_range[1]),
    ]
    outputs.F.PA_top_view_angle_range = [
        degrees(constant.F.PA_top_view_angle_range[0]),
        degrees(constant.F.PA_top_view_angle_range[1]),
    ]
    outputs.F.PF_top_view_angle_range = [
        degrees(constant.F.PF_top_view_angle_range[0]),
        degrees(constant.F.PF_top_view_angle_range[1]),
    ]
    outputs.F.PA_front_view_angle_range = [
        degrees(constant.F.PA_front_view_angle_range[0]),
        degrees(constant.F.PA_front_view_angle_range[1]),
    ]
    outputs.F.PF_front_view_angle_range = [
        degrees(constant.F.PF_front_view_angle_range[0]),
        degrees(constant.F.PF_front_view_angle_range[1]),
    ]

    outputs.R.U_top_view_angle = degrees(constant.R.U_top_view_angle)
    outputs.R.UF_side_view_angle_range = [
        degrees(constant.R.UF_side_view_angle_range[0]),
        degrees(constant.R.UF_side_view_angle_range[1]),
    ]
    outputs.R.UA_side_view_angle_range = [
        degrees(constant.R.UA_side_view_angle_range[0]),
        degrees(constant.R.UA_side_view_angle_range[1]),
    ]
    outputs.R.L_top_view_angle = degrees(constant.R.L_top_view_angle)
    outputs.R.LF_side_view_angle_range = [
        degrees(constant.R.LF_side_view_angle_range[0]),
        degrees(constant.R.LF_side_view_angle_range[1]),
    ]
    outputs.R.LA_side_view_angle_range = [
        degrees(constant.R.LA_side_view_angle_range[0]),
        degrees(constant.R.LA_side_view_angle_range[1]),
    ]
    outputs.R.PA_top_view_angle_range = [
        degrees(constant.R.PA_top_view_angle_range[0]),
        degrees(constant.R.PA_top_view_angle_range[1]),
    ]
    outputs.R.PF_top_view_angle_range = [
        degrees(constant.R.PF_top_view_angle_range[0]),
        degrees(constant.R.PF_top_view_angle_range[1]),
    ]
    outputs.R.PA_rear_view_angle_range = [
        degrees(constant.R.PA_rear_view_angle_range[0]),
        degrees(constant.R.PA_rear_view_angle_range[1]),
    ]
    outputs.R.PF_rear_view_angle_range = [
        degrees(constant.R.PF_rear_view_angle_range[0]),
        degrees(constant.R.PF_rear_view_angle_range[1]),
    ]
    ...
    if S.units == "metric":  # if metric convert all outputs to metric
        ...
        outputs.F.Panhard_Transverse_Movement = in2mm(
            travel.R.panhard_transverse_movement
        )
        outputs.F.IC = in2mm(travel.F.IC)
        outputs.F.Anti_CG = in2mm(constant.F.anti_CG)
        outputs.F.Hub = in2mm(travel.F.hub)
        outputs.F.Sprung_CG_height_Above_Roll_Center = in2mm(
        ...
        outputs.V.Sprung_CG_height_Above_Roll_Axis = in2mm(
            constant.V.sprung_CG_height_above_roll_axis
        )
        ...
        outputs.F.Sprung_CG_height_Above_Roll_Center = (
            constant.F.sprung_CG_height_above_roll_center * 1
        )
        ...
        outputs.R.Sprung_CG_height_Above_Roll_Center = (
            constant.R.sprung_CG_height_above_roll_center * 1
        )
        ...
        outputs.V.Sprung_CG_height_Above_Roll_Axis = (
            constant.V.sprung_CG_height_above_roll_axis * 1
        )
