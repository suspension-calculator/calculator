...
def input_processing_shocks():
    ...
    constant.F.main_spring_length = "{:.0f}".format(
        inputs.F.shock1.travel + inputs.F.shock1.main_spring_extra_length * 1
    )
    ...
    constant.R.main_spring_length = "{:.0f}".format(
        inputs.R.shock1.travel + inputs.R.shock1.main_spring_extra_length * 1
    )
    ...
    if S.reversed_front_x:
        constant.F.shock1.chassis_mount[x] = (
            constant.V.wheelbase - constant.F.shock1.chassis_mount[x]
        )
        constant.F.shock1.susp_mount[x] = (
            constant.V.wheelbase - constant.F.shock1.susp_mount[x]
        )
        constant.F.shock2.chassis_mount[x] = (
            constant.V.wheelbase - constant.F.shock2.chassis_mount[x]
        )
        constant.F.shock2.susp_mount[x] = (
            constant.V.wheelbase - constant.F.shock2.susp_mount[x]
        )
    else:
        constant.F.shock1.chassis_mount[x] = (
            constant.V.wheelbase + constant.F.shock1.chassis_mount[x]
...
def output_processing_shocks():
    ...
    outputs.F.Shock1.Percent_Bump_Remaining = (
        constant.F.shock1.percent_bump_reminaing * 1
    )
    ...
    outputs.F.Shock2.Percent_Bump_Remaining = (
        constant.F.shock2.percent_bump_reminaing * 1
    )
    ...
    outputs.R.Shock1.Percent_Bump_Remaining = (
        constant.R.shock1.percent_bump_reminaing * 1
    )
    ...
    outputs.R.Shock2.Percent_Bump_Remaining = (
        constant.R.shock2.percent_bump_reminaing * 1
    )
    ...
    if S.units == "metric":
        ...
        outputs.F.Shock1.Lever_Arm_2_Body_Roll = in2mm(
            constant.F.shock1.distance_to_body_roll_axis
        )
        outputs.F.Shock1.Corner_Sprung_Weight = lb2kg(constant.F.corner_sprung_weight)
        outputs.F.Shock1.Ideal_Main_Spring = lbpin2npmm(
            constant.F.target_main_spring_rate
        )
        outputs.F.Shock1.Ideal_Tender_Spring = lbpin2npmm(
            constant.F.target_tender_spring_rate
        )
        outputs.F.Shock1.Closest_Main_Spring = lbpin2npmm(
            constant.F.closest_match_main_spring
        )
        outputs.F.Shock1.Closest_Tender_Spring = lbpin2npmm(
        ...
        outputs.F.Shock2.Lever_Arm_2_Body_Roll = in2mm(
            constant.F.shock2.distance_to_body_roll_axis
        )
        ...
        outputs.R.Shock1.Lever_Arm_2_Body_Roll = in2mm(
            constant.R.shock1.distance_to_body_roll_axis
        )
        outputs.R.Shock1.Corner_Sprung_Weight = lb2kg(constant.R.corner_sprung_weight)
        outputs.R.Shock1.Ideal_Main_Spring = lbpin2npmm(
            constant.R.target_main_spring_rate
        )
        outputs.R.Shock1.Ideal_Tender_Spring = lbpin2npmm(
            constant.R.target_tender_spring_rate
        )
        outputs.R.Shock1.Closest_Main_Spring = lbpin2npmm(
            constant.R.closest_match_main_spring
        )
        outputs.R.Shock1.Closest_Tender_Spring = lbpin2npmm(
        ...
        outputs.R.Shock2.Lever_Arm_2_Body_Roll = in2mm(
            constant.R.shock2.distance_to_body_roll_axis
        )
        ...
        outputs.F.Shock1.Lever_Arm_2_Body_Roll = (
            constant.F.shock1.distance_to_body_roll_axis * 1
        )
        ...
        outputs.F.Shock1.Closest_Tender_Spring = (
            constant.F.closest_match_tender_spring * 1
        )
        outputs.F.Shock1.Closest_Step_Up = constant.F.closest_match_SUR * 1
        ...
        outputs.F.Shock2.Lever_Arm_2_Body_Roll = (
            constant.F.shock2.distance_to_body_roll_axis * 1
        )
        ...
        outputs.R.Shock1.Lever_Arm_2_Body_Roll = (
            constant.R.shock1.distance_to_body_roll_axis * 1
        )
        ...
        outputs.R.Shock1.Closest_Tender_Spring = (
            constant.R.closest_match_tender_spring * 1
        )
        outputs.R.Shock1.Closest_Step_Up = constant.R.closest_match_SUR * 1
        ...
        outputs.R.Shock2.Lever_Arm_2_Body_Roll = (
            constant.R.shock2.distance_to_body_roll_axis * 1
        )
