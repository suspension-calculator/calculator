...
class shockPage(tk.Frame):
    def __init__(self,master):
        ...
        if True: # Page Selection
            ...
            button4 = tk.Button(calc_page_sel, text ="Shocks", fg=buttonColor, bg=pressedButtonColor, command = lambda : master.switch_frame("shocks"),height= 1, width=12,font=(fontType,13))
        ...
        def update_outputs(*args):
            ...
            if plots_changed:
                ...
                if True: # Update Vehicle
                    if True: # Update Vehicle Plots
                        a=8

                    if True: # Update Vehicle Text
                        a=9
