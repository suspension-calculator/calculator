...
class pitchPage(tk.Frame):
    def __init__(self,master):
        ...
        if True: # Page Selection
            ...
            button5 = tk.Button(calc_page_sel, text ="Vehicle Pitch", fg=buttonColor, bg=pressedButtonColor, command = lambda : master.switch_frame("pitch"),height= 1, width=12,font=(fontType,13))
